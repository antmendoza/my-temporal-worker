...
public class TemporalOptionsConfig {
  ...
  private final SslContextBuilderProvider sslContextBuilderProvider;

  public TemporalOptionsConfig(SslContextBuilderProvider sslContextBuilderProvider) {
    this.sslContextBuilderProvider = sslContextBuilderProvider;
  }
  ...
  public TemporalOptionsCustomizer<WorkflowServiceStubsOptions.Builder>
    ...
    return new TemporalOptionsCustomizer<WorkflowServiceStubsOptions.Builder>() {
      ...
      public WorkflowServiceStubsOptions.Builder customize(
        ...
        optionsBuilder.setSslContext(sslContextBuilderProvider.getSslContext());
